...
class TagPrinter:
    ...
    def __init__(self, tags, indent_tags=15, space_between_tags=3, key_columns=None):
        self.tags = tags
    ...
    def print(self, with_id=True):
        if self.key_columns:
            ...
            for item in self.tags:
                self.print_item(item, with_id)

    def print_item(self, item, with_id=True):
        if with_id:
            space = ' ' * 2
