...
static void createModuleConstants(void) {
    loadConstantsBlob(&mod_consts[0], "__main__", 13);
...
void checkModuleConstants___main__(void) {
    ...
    checkConstantsBlob(&mod_consts[0], "__main__", 13);
}
#endif

// The module code objects.
static PyCodeObject *codeobj_089a3f9f944a9f1283a24b6879e06cae;
/* For use in "MainProgram.c". */
PyCodeObject *codeobj_main = NULL;

static void createModuleCodeObjects(void) {
    module_filename_obj = mod_consts[1]; CHECK_OBJECT(module_filename_obj);
    codeobj_089a3f9f944a9f1283a24b6879e06cae = MAKE_CODEOBJECT(module_filename_obj, 1, CO_NOFREE, mod_consts[12], NULL, NULL, 0, 0, 0);
}
...
// Mark the execution in the "__spec__" value.
    ...
    struct Nuitka_FrameObject *frame_089a3f9f944a9f1283a24b6879e06cae;
    ...
    // Module code.
    // Frame without reuse.
    frame_089a3f9f944a9f1283a24b6879e06cae = MAKE_MODULE_FRAME(codeobj_089a3f9f944a9f1283a24b6879e06cae, module___main__);

    // Push the new frame as the currently active one, and we should be exclusively
    // owning it.
    pushFrameStack(frame_089a3f9f944a9f1283a24b6879e06cae);
    assert(Py_REFCNT(frame_089a3f9f944a9f1283a24b6879e06cae) == 2);

    // Framed code:
    {
        PyObject *tmp_imported_value_1;
        frame_089a3f9f944a9f1283a24b6879e06cae->m_frame.f_lineno = 1;
    ...
    }
    {
        ...
        frame_089a3f9f944a9f1283a24b6879e06cae->m_frame.f_lineno = 3;
    ...
    }
    {
        ...
        frame_089a3f9f944a9f1283a24b6879e06cae->m_frame.f_lineno = 5;
    ...
    }
    {
        ...
        frame_089a3f9f944a9f1283a24b6879e06cae->m_frame.f_lineno = 7;
...
#if 0
    RESTORE_FRAME_EXCEPTION(frame_089a3f9f944a9f1283a24b6879e06cae);
#endif
    popFrameStack();

    assertFrameObject(frame_089a3f9f944a9f1283a24b6879e06cae);
    ...
    if (exception_tb == NULL) {
        exception_tb = MAKE_TRACEBACK(frame_089a3f9f944a9f1283a24b6879e06cae, exception_lineno);
    } else if (exception_tb->tb_frame != &frame_089a3f9f944a9f1283a24b6879e06cae->m_frame) {
        exception_tb = ADD_TRACEBACK(exception_tb, frame_089a3f9f944a9f1283a24b6879e06cae, exception_lineno);
    }
